...
therms, realz = noise.thermLevel()
cmat = noise.covmat(noise=therms)
cmatInv = noise.covmatInv(noise=therms)

''' Getting the noise covariance weighted modelling sets '''
wgt_m21 = noise.wgtTs(modset=m21.T, opt='21', noise=therms)
wgt_mFg = noise.wgtTs(modset=mFg.T, opt='FG', noise=therms)
